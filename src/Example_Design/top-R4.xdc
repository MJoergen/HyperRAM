...
set_property -dict {PACKAGE_PIN J19  IOSTANDARD LVCMOS33}                                    [get_ports {reset_i}]
...
create_generated_clock -name delay_refclk [get_pins clk_inst/i_clk_hyperram/CLKOUT1]
create_generated_clock -name hr_clk_del   [get_pins clk_inst/i_clk_hyperram/CLKOUT2]
create_generated_clock -name hr_clk       [get_pins clk_inst/i_clk_hyperram/CLKOUT3]

# HyperRAM output clock relative to delayed clock
create_generated_clock -name hr_ck         [get_ports hr_ck_o] \
   -source [get_pins clk_inst/i_clk_hyperram/CLKOUT2] -multiply_by 1
...
set_max_delay 2 -datapath_only -from [get_cells core_inst/hyperram_inst/hyperram_ctrl_inst/hb_read_o_reg]
set_max_delay 2 -datapath_only -from [get_cells core_inst/hyperram_inst/hyperram_rx_inst/iddr_dq_gen[*].iddr_dq_inst]

# Prevent insertion of extra BUFG
set_property CLOCK_BUFFER_TYPE NONE [get_nets -of [get_pins core_inst/hyperram_inst/hyperram_rx_inst/delay_rwds_inst/DATAOUT]]
...
set_property IOB TRUE [get_cells core_inst/hyperram_inst/hyperram_tx_inst/hr_rwds_oe_n_reg ]
set_property IOB TRUE [get_cells core_inst/hyperram_inst/hyperram_tx_inst/hr_dq_oe_n_reg[*] ]
set_property IOB TRUE [get_cells core_inst/hyperram_inst/hyperram_ctrl_inst/hb_csn_o_reg ]
set_property IOB TRUE [get_cells core_inst/hyperram_inst/hyperram_ctrl_inst/hb_rstn_o_reg ]
...
########### MEGA65 timing ################
# Rename autogenerated clocks
create_generated_clock -name kbd_clk    [get_pins mega65_inst/clk_mega65_inst/i_clk_mega65/CLKOUT0]
create_generated_clock -name pixel_clk  [get_pins mega65_inst/clk_mega65_inst/i_clk_mega65/CLKOUT1]
create_generated_clock -name pixel_clk5 [get_pins mega65_inst/clk_mega65_inst/i_clk_mega65/CLKOUT2]
