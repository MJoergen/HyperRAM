...
create_generated_clock -name delay_refclk [get_pins clk_controller_inst/clk_hyperram_inst/CLKOUT1]
create_generated_clock -name hr_clk_del   [get_pins clk_controller_inst/clk_hyperram_inst/CLKOUT2]
create_generated_clock -name hr_clk       [get_pins clk_controller_inst/clk_hyperram_inst/CLKOUT3]

# HyperRAM output clock relative to delayed clock
create_generated_clock -name hr_ck         [get_ports hr_ck_o] \
   -source [get_pins clk_controller_inst/clk_hyperram_inst/CLKOUT2] -multiply_by 1
